...
**Highschool network:** ~98.6% of node pairs can be reached within 6 path lengths.
- Most shortest paths are around 3–5 steps.
- Very few exceed 6; maximum is around 7–8.

**Facebook network:** ~98.0% of node pairs can be reached within 6 path lengths.
